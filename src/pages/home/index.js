                ...
                <div className="article-conteudo content" >
                    {gabarito[0].exibir ?
                        <article>
                            ...
                            <VolumeUp onClick={() => play(midia_1)} className='volume'/><VolumeUp onClick={() => play(midia_1)} className='volume'/>
                        ...
                        <article>
                            ...
                            <h2>COMPONENTES BÁSICOS DE UM COMPUTADOR</h2>
                        ...
                        <article>
                            ...
                            <h2>ARQUITETURA SIMPLIFICADA DE UM COMPUTADOR</h2>
                        ...
                        <article>
                            ...
                            <h2>FUNÇÕES DOS COMPONENTES BÁSICOS</h2>
                            <br></br>
                        ...
                        <article>
                            ...
                            <h2>UNIDADE CENTRAL DE PROCESSAMENTO – CPU</h2>
                            <br></br>
